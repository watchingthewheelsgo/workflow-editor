...
const DEFAULT_ICON_MAP: Record<BlockEnum, React.ComponentType<{ className: string }>> = {
  ...
  [BlockEnum.Message]: Agent,
  [BlockEnum.SlotFilling]: Agent,
  [BlockEnum.Router]: IfElse,
...
const ICON_CONTAINER_BG_COLOR_MAP: Record<string, string> = {
  ...
  [BlockEnum.Message]: 'bg-util-colors-indigo-indigo-500',
  [BlockEnum.SlotFilling]: 'bg-util-colors-indigo-indigo-500',
  [BlockEnum.Router]: 'bg-util-colors-cyan-cyan-500',
