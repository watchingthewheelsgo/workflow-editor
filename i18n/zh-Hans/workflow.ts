const translation = {
  ...
  workflowMeta: {
    ...
    nameRequired: '工作流名称必填',
    nameLengthLimit: '名称不能超过 {{limit}} 个字符',
    goal: '目标',
    goalPlaceholder: '描述工作流的目标',
    goalRequired: '工作流目标必填',
    goalLengthLimit: '目标不能超过 {{limit}} 个字符',
    button: '工作流元数据',
  },
  publishLimit: {
  ...
  nodes: {
    ...
    router: {
      condition: '条件',
      conditionTip: '定义路由条件或标准',
      conditionPlaceholder: '例如：如果用户意图是"预订"，则路由到预订流程',
      useModel: '使用 LLM 模型',
      model: '模型配置',
      modelTip: '可选的 LLM 模型用于评估复杂条件',
      modelName: '模型名称',
      temperature: '温度 (0.0 - 1.0)',
      notSet: '未设置',
      outputVars: {
        selectedBranch: '路由器选择的分支',
