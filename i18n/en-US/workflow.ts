const translation = {
  ...
  workflowMeta: {
    title: 'Workflow Meta',
    subtitle: 'Set workflow name and goal',
    name: 'Name',
    namePlaceholder: 'Enter workflow name',
    nameRequired: 'Workflow name is required',
    nameLengthLimit: 'Name can\'t exceed {{limit}} characters',
    goal: 'Goal',
    goalPlaceholder: 'Describe the workflow goal',
    goalRequired: 'Workflow goal is required',
    goalLengthLimit: 'Goal can\'t exceed {{limit}} characters',
    button: 'Workflow Meta',
  },
  publishLimit: {
  ...
  blocksAbout: {
    ...
    'message': 'A flexible node for processing text messages with optional LLM integration',
    'slot-filling': 'A node for iteratively collecting and validating slot values from users',
    'router': 'A node for conditional routing based on criteria or LLM evaluation',
  ...
  nodes: {
    ...
    message: {
      mode: 'Mode',
      modeTip: 'Choose between LLM mode (flexible) or Strict mode (fixed response)',
      message: 'Message Content',
      messageTip: 'The message content to be processed',
      messagePlaceholder: 'Enter message content...',
      model: 'Model Configuration',
      modelTip: 'Configure the LLM model settings',
      modelName: 'Model Name',
      modelNamePlaceholder: 'e.g., gpt-4, claude-3',
      temperature: 'Temperature (0.0 - 1.0)',
      notSet: 'Not Set',
      outputVars: {
        text: 'The processed or generated text output',
        mode: 'The mode used (llm or strict)',
        model: 'Model configuration details',
        tokensUsed: 'Number of tokens used in LLM mode',
      },
    },
    slotFilling: {
      slotName: 'Slot Name',
      slotNameTip: 'The name of the slot to fill',
      slotNamePlaceholder: 'e.g., user_name, email, phone',
      question: 'Question',
      questionTip: 'The question to ask the user to fill this slot',
      questionPlaceholder: 'e.g., What is your full name?',
      model: 'Model Configuration',
      modelTip: 'Configure the LLM model for slot filling',
      modelName: 'Model Name',
      modelNamePlaceholder: 'e.g., gpt-4.1, gpt-5',
      temperature: 'Temperature (0.0 - 1.0)',
      maxTurns: 'Max Turns',
      maxTurnsTip: 'Maximum number of attempts to fill this slot (1-10)',
      validation: 'Enable Validation',
      validationCriteria: 'Validation Criteria',
      validationCriteriaTip: 'Define criteria for validating the filled value',
      validationCriteriaPlaceholder: 'e.g., Must be a valid email address',
      validationModel: 'Validation Model',
      validationModelTip: 'Optional LLM model for validation',
      notSet: 'Not Set',
      outputVars: {
        filledValue: 'The value filled for this slot',
        turnsUsed: 'Number of turns used to fill this slot',
        validationPassed: 'Whether the validation passed',
      },
    },
    router: {
      condition: 'Condition',
      conditionTip: 'Define the routing condition or criteria',
      conditionPlaceholder: 'e.g., if user intent is "booking", route to booking flow',
      useModel: 'Use LLM Model',
      model: 'Model Configuration',
      modelTip: 'Optional LLM model to evaluate complex conditions',
      modelName: 'Model Name',
      temperature: 'Temperature (0.0 - 1.0)',
      notSet: 'Not Set',
      outputVars: {
        selectedBranch: 'The branch selected by the router',
